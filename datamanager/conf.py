class Conf:
	...
	TRAINING_SETS_FOLDER = DATA_PATH + 'training-sets/';
	...
	TRAINING_SET_WINS = TRAINING_SETS_FOLDER + "START-to-END.win"
	TRAINING_SET_SHOWS = TRAINING_SETS_FOLDER + "START-to-END.show"
	TRAINING_SET_INPUTS = TRAINING_SETS_FOLDER + "START-to-END.inputs"
